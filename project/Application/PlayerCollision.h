...
public:
	...
	const ColNormal& IsColX(const AABB& playerAABB, const float& playerVelocityX) const;
	...
	const ColNormal& IsColZ(const AABB& playerAABB, const float& playerVelocityZ) const;
